...
echo -e "[\e[00;32mok\e[00m] structure created";

if [ "$STYLEEXT" == "less" ]; then
	command -v drush >/dev/null 2>&1 || { echo -e >&2 "[\e[00;32mWarning\e[00m] If drush is installed i can download less module."; exit 1; }
